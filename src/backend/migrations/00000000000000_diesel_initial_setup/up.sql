...
CREATE TABLE
    IF NOT EXISTS omini_users (id uuid PRIMARY KEY NOT NULL);

CREATE TABLE
    IF NOT EXISTS omini_alive_messages (id uuid PRIMARY KEY NOT NULL);

CREATE TABLE
    IF NOT EXISTS omini_calls (id uuid PRIMARY KEY NOT NULL);