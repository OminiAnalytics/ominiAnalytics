!(function (a, e) {
  typeof exports === 'object' && typeof module === 'object'
    ...
    : typeof define === 'function' && define.amd
      ? define('OminiTracker', [], e)
      : typeof exports === 'object'
        ? (exports.OminiTracker = e())
        : (a.OminiTracker = e())
})(this, () => {
  const n = {
    249: function (a, e, b) {
      a.exports = (function (m) {
        ...
        const n =
              Object.create ||
              function (a) {
                return (g.prototype = a), (a = new g()), (g.prototype = null), a
              }
        const a = {}
        const e = (a.lib = {})
        const o = (e.Base = {
          ...
          init: function () {},
          mixIn: function (a) {
            for (const e in a) a.hasOwnProperty(e) && (this[e] = a[e])
        ...
        var l = (e.WordArray = o.extend({
          init: function (a, e) {
            ;(a = this.words = a || []),
            (this.sigBytes = e != null ? e : 4 * a.length)
          },
          toString: function (a) {
          ...
          concat: function (a) {
            ...
            if ((this.clamp(), i % 4)) {
              for (let r = 0; r < o; r++) {
                const t = (n[r >>> 2] >>> (24 - (r % 4) * 8)) & 255
                e[(i + r) >>> 2] |= t << (24 - ((i + r) % 4) * 8)
              }
            } else { for (let s = 0; s < o; s += 4) e[(i + s) >>> 2] = n[s >>> 2] }
            return (this.sigBytes += o), this
          },
          clamp: function () {
            const a = this.words
            const e = this.sigBytes
                ;(a[e >>> 2] &= 4294967295 << (32 - (e % 4) * 8)),
            (a.length = m.ceil(e / 4))
          },
          clone: function () {
            const a = o.clone.call(this)
            return (a.words = this.words.slice(0)), a
          },
          random: function (a) {
            for (var e = [], n = 0; n < a; n += 4) {
              e.push(
                (function () {
                  if (i) {
        ...
        var t = (r.Hex = {
          stringify: function (a) {
            for (
              var e = a.words, n = a.sigBytes, i = [], o = 0;
              o < n;
              o++
            ) {
              const r = (e[o >>> 2] >>> (24 - (o % 4) * 8)) & 255
              i.push((r >>> 4).toString(16)), i.push((15 & r).toString(16))
            }
            return i.join('')
          },
          parse: function (a) {
            for (var e = a.length, n = [], i = 0; i < e; i += 2) {
              n[i >>> 3] |=
                    parseInt(a.substr(i, 2), 16) << (24 - (i % 8) * 4)
            }
        ...
        const s = (r.Latin1 = {
          ...
          parse: function (a) {
            for (var e = a.length, n = [], i = 0; i < e; i++) { n[i >>> 2] |= (255 & a.charCodeAt(i)) << (24 - (i % 4) * 8) }
        ...
        const u = (e.BufferedBlockAlgorithm = o.extend({
          reset: function () {
            ;(this._data = new l.init()), (this._nDataBytes = 0)
          },
          _append: function (a) {
            typeof a === 'string' && (a = c.parse(a)),
            this._data.concat(a),
          ...
          _process: function (a) {
            ...
            const s =
                    (t = a
                      ? m.ceil(t)
                      : m.max((0 | t) - this._minBufferSize, 0)) * r
            var a = m.min(4 * s, o)
            if (s) {
              for (let c = 0; c < s; c += r) this._doProcessBlock(i, c)
              ;(e = i.splice(0, s)), (n.sigBytes -= a)
            }
            return new l.init(e, a)
          },
          clone: function () {
        ...
        var A =
              ((e.Hasher = u.extend({
                ...
                _createHelper: function (n) {
                  return function (a, e) {
                    return new n.init(e).finalize(a)
                  }
                },
                _createHmacHelper: function (n) {
                  return function (a, e) {
                    return new A.HMAC.init(n, e).finalize(a)
                  }
                }
              })),
              (a.algo = {}))
          ...
          (a.enc.Base64 = {
            ...
            parse: function (a) {
              ...
              if (!(i = this._reverseMap)) {
                for (var i = (this._reverseMap = []), o = 0; o < n.length; o++) { i[n.charCodeAt(o)] = o }
              }
              for (
                var r,
                  t = n.charAt(64),
                  s = (!t || ((t = a.indexOf(t)) !== -1 && (e = t)), a),
                  c = e,
                  m = i,
                  l = [],
                  u = 0,
                ...
                A % 4 &&
                  ((r =
                    (m[s.charCodeAt(A - 1)] << ((A % 4) * 2)) |
                    (m[s.charCodeAt(A)] >>> (6 - (A % 4) * 2))),
                  (l[u >>> 2] |= r << (24 - (u % 4) * 8)),
                  u++)
              }
              return g.create(l, u)
    ...
    743: function (a, e, n) {
      a.exports = n(249).enc.Utf8
    },
    10: function (a, e, n) {
      a.exports = ((a = n(249)), n(153), n(824), a.HmacSHA256)
    },
    824: function (a, e, n) {
      let s
      a.exports =
          ...
          void (a.algo.HMAC = n.extend({
            init: function (a, e) {
              ...
              const n = a.blockSize
              const i = 4 * n
              ;(e = e.sigBytes > i ? a.finalize(e) : e).clamp()
              for (
                ...
                (o[t] ^= 1549556828), (r[t] ^= 909522486)
              }(a.sigBytes = e.sigBytes = i), this.reset()
            },
            reset: function () {
            ...
            finalize: function (a) {
              ...
              var a = e.finalize(a)
              return e.reset(), e.finalize(this._oKey.clone().concat(a))
            }
          })))
    },
    153: function (a, e, n) {
      ...
      a.exports =
          ...
          (function (o) {
            ...
            for (let s = 2, c = 0; c < 64;) {
              !(function (a) {
                for (let e = o.sqrt(a), n = 2; n <= e; n++) if (!(a % n)) return
                return 1
              })(s) ||
                (c < 8 && (r[c] = t(o.pow(s, 0.5))),
                (b[c] = t(o.pow(s, 1 / 3))),
                c++),
              s++
            }
            const d = []
            var e = (e.SHA256 = i.extend({
              _doReset: function () {
              ...
              _doFinalize: function () {
                ...
                const i = 8 * a.sigBytes
                return (
                  (e[i >>> 5] |= 128 << (24 - (i % 32))),
                  (e[14 + (((64 + i) >>> 9) << 4)] = o.floor(n / 4294967296)),
                  (e[15 + (((64 + i) >>> 9) << 4)] = n),
              ...
              clone: function () {
                const a = i.clone.call(this)
                return (a._hash = this._hash.clone()), a
              }
            }))
            ;(a.SHA256 = i._createHelper(e)),
            (a.HmacSHA256 = i._createHmacHelper(e))
          })(Math),
          m.SHA256)
    },
    480: () => {}
  ...
  function g (a) {
    ...
    return (
      void 0 !== e ||
        ...
        n[a].call(e.exports, e, e.exports, g)),
      e.exports
    )
  }
  ;(g.n = (a) => {
  ...
  (g.o = (a, e) => Object.prototype.hasOwnProperty.call(a, e))
  const b = {}
  return (
    (() => {
      'use strict'
      ...
      class e {
        constructor (a) {
          ;(this.url = a),
          this.url.slice(-1) === '/' && (this.url = this.url.slice(0, -1)),
          (this.endpoints = {
            uid: '/api/uid',
            parkour: '/api/parkour',
            alive: '/api/alive',
        ...
        async getData ({ endpoint: a, params: e, headers: n }) {
          const i = new r()
          const o =
            '?' +
            Object.keys(e)
          ...
          return (
            ...
            await fetch(this.url + this.endpoints[a] + o, {
              method: 'GET',
              headers: n,
              mode: 'cors'
            })
        ...
        async postDataJSON ({ endpoint: a, data: e }) {
          const n = new r()
          return (
            await fetch(this.url + this.endpoints[a], {
              method: 'POST',
              headers: {
      ...
      class r {
        ...
        new ({ result: a, response: e, error: n }) {
          ;(this.result = a),
        ...
        async toJson () {
          this.data = await this.data.json().then((a) => a)
        }

        async clone () {
          this.data = await this.data.clone().then((a) => a)
        }
      }
      class n {
        constructor (a) {
        ...
        async getUid () {
          if (navigator.cookieEnabled) {
            ...
            let n
            return (
              document.cookie.indexOf('Om_uid') > -1
                ? ((n = document.cookie.split('Om_uid=')[1].split(';')[0]),
                  ([a, e] = await this.validateUidFetch(n).then((a) => a)))
                : ([a, e] = await this.validateUidFetch('').then((a) => a)),
              console.log(e),
              a === 'success'
                ? (this.setCookie(e), ['success', e])
                : ['error', !1]
            )
          }
          return ['error', !1]
        ...
        setCookie (a) {
          document.cookie =
            'Om_uid=' + a + '; max-age=31536000; samesite=strict; Path=/'
        }

        async init () {
          const [a, e] = await this.getUid()
          a === 'success' && ((this.uid = e), (this.userIsValid = !0))
        }

        async validateUidFetch (a) {
          if (void 0 !== this.collect) {
            const e = await this.api.postDataJSON({
              endpoint: 'uid',
              data: {
                uid: a,
                bp: this.collect
      ...
      const c = {
        ...
        getGPU: function () {
          ...
          let e
          return a && (e = a.getExtension('WEBGL_debug_renderer_info'))
            ? a.getParameter(e.UNMASKED_RENDERER_WEBGL)
            : 'unknown'
        },
        getColorBufferFloat: function () {
          const a = document.createElement('canvas').getContext('webgl')
          let e
          return a && (e = a.getExtension('WEBGL_color_buffer_float'))
            ? e.RGBA32F_EXT
            : 0
        },
        getScreen: function () {
      ...
      const m = {
        ...
        gbrowser: function () {
          if (void 0 !== this.uag) {
            const a = this.uag.brands.filter(
              (a) =>
                a.brand.indexOf('Brand') === -1 &&
                  a.brand.indexOf('Chromium') === -1
            )[0]
            return {
              name: a.brand,
          ...
          const a = this.ua.match(
            /(YaBrowser|Vivaldi|OPR|Firefox|Safari|Edge|Trident|Chrome)\/([\S]+)/i
          )
          return {
            name: this.nav.brave && this.nav.brave.isBrave() ? 'Brave' : a[0],
            version: a[1].split('.')[0],
            fversion: a[1]
          }
        },
      ...
      const l = {
        ...
        wrap: async function () {
          ...
          var e = await this.getOsAndTypeExp().then((a) => a)
          const n = e[0]
          var e = e[1]
          return {
            name: n.name,
        ...
        getArch: function () {
          ...
          return (
            this.os === 'Windows'
              ? (a =
                    this.ua.indexOf('WOW64') !== -1 ||
                    this.ua.indexOf('Win64') !== -1
                      ? 'x64'
                      : 'x32')
              : this.os === 'Linux'
                ? this.ua.indexOf('x86_64') !== -1
                  ? (a = 'x64')
                  : this.ua.indexOf('i686') !== -1 && (a = 'x32')
                : (this.ua.indexOf('adm64') === -1 &&
                    !this.ua.indexOf('arm64')) ||
                  (a = 'x64'),
            a
          )
        },
        getOsAndTypeExp: function () {
            ...
            return this.uag
              ...
              .then((e) => {
                if (e.platform === 'Windows') {
                  let a = 'unknown'
                  switch (
                    e.platformVersion.split('.').slice(0, 2).join('.')
                  ) {
                    case '11.0':
                    case '12.0':
                    case '13.0':
                  ...
                  (n = {
                    name: e.platform,
                    version: e.platformVersion
                  }),
                  (i = e.mobile ? 'mobile' : 'desktop')
                }
                return (
                  (n = n || {
                    name: 'unknown',
          ...
          {
            const [n, i] = this.getOsAndType()
            return [n, i]
          }
        },
        getOsAndType: function () {
          let a
          return this.testWindows()[0]
            ? [
                {
                  name: (a = this.testWindows())[1],
                  version: a[2]
                },
                a[3]
              ]
                ...
                : this.testAndroid()[0]
                  ...
                  : this.testIphone()[0]
                    ...
                    : this.testChromeOS()[0]
                      ? [
                          {
                            name: (a = this.testChromeOS())[1],
                            version: a[2]
                          },
                          a[3]
                        ]
                      : this.testBlackBerry()[0]
                        ? [
                            {
                              name: (a = this.testBlackBerry())[1],
                              version: a[2]
                            },
                            a[3]
                          ]
                        : this.testSymbian()[0]
                          ...
                          : this.testIpod()[0]
                            ...
                            : this.testIpad()[0]
                              ? [
                                  {
                                    name: (a = this.testIpad())[1],
                                    version: a[2]
                                  },
                                  a[3]
                                ]
                              : this.testWindowsPhone()[0]
                                ? [
                                    {
                                      name: (a = this.testWindowsPhone())[1],
                                      version: a[2]
                                    },
                                    a[3]
                                  ]
        ...
        testWindows: function () {
          if (this.ua.indexOf('Windows NT') > -1) {
            let a = this.ua.match(/Windows NT (\d+\.\d+)/i)
            switch (a[1]) {
              case '10.0':
                a = '10'
                break
        ...
        testMac: function () {
          if (
            ...
            let a = this.ua.match(/Mac OS X (\d+_\d+)/i)
            return [
              !0,
              'macOS',
              (a = a ? a[1].replace('_', '.') : 'unknown'),
              'desktop'
            ]
          }
          return [!1, '', '', '']
      ...
      const u = {
        getCountry: function () {
          ...
          return (
            Object.keys(i.Ao).forEach((a) => {
              e[a] = i.hW[i.Ao[a].countries[0]].name
            }),
            e[a] || 'unknown'
          )
        },
      ...
      const A = class {
        constructor (a) {
          ;(this.api = new e(a)), (this.user = new n(this.api))
        }
        ...
        async initTracker () {
          !(async function () {
            ...
            console.log(n)
            const i = s()(n, navigator.userAgent)
            return [o().stringify(t().parse(n)), i.toString()]
          })().then((a) => {
            const e = a[0]
            var a = a[1]
              ;(this.user.collect = {
