 ...
 * Author: realbacon
 * -----
 * Last Modified: 29/08/2022 11:19:18
...
!(function (a, e) {
    ...
    (() => {
        ...
        function n(i) {
            ...
            var r = (e[i] = { exports: {} });
            return a[i](r, r.exports, n), r.exports;
        }
        (n.d = (a, e) => {
            for (var i in e)
                n.o(e, i) &&
        ...
        return (
            (() => {
                ...
                class a {
                    ...
                    async getData({ endpoint: a, params: e }) {
                        var n;
                        return (
                            (n =
                                "?" +
                                Object.keys(e)
                                    ...
                                    .join("&")),
                            await fetch(this.url + this.endpoints[a] + n, {
                                method: "GET",
                                headers: { "Content-Type": "application/json" },
                                mode: "cors",
                            })
                                .then((a) => ["success", a.json()])
                                .catch(
                                    (a) => (
                    ...
                    async postDataJSON({ endpoint: a, data: n }) {
                        var i = new e();
                        return (
                ...
                class o {
                    constructor(a) {
                        this.uid, (this.api = a), (this.userIsValid = !1);
                    }
                    populate({ browser: a, os: e, type: n, country: i }) {
                        (this.browser = a),
                            (this.os = e),
                            (this.type = n),
                            (this.country = i);
                        ...
                        if (navigator.cookieEnabled) {
                            if (document.cookie.indexOf("Om_uid") > -1) {
                                const n = document.cookie
                                    .split("Om_uid=")[1]
                                    .split(";")[0];
                                var [a, e] = await this.validateUidFetch(
                                    n
                                ).then();
                            } else var [a, e] = this.validateUidFetch("");
                            return (
                                console.log(e),
                                "success" === a
                ...
                const { countries: r, zones: t } = n(599);
                class s {
                    constructor() {
                        this.country;
                    }
                ...
                class m {
                    constructor() {
                        (this.browser = { name: void 0, version: void 0 }),
                    ...
                    async initTracker() {
                        (this.browser = this.getBrowser()),
                            ([this.os, this.type] =
                                await this.getOsAndTypeExp());
                    }
                    getBrowser() {
                        if (null != navigator.userAgentData) {
                            let a = navigator.userAgentData.brands.filter(
                                (a) =>
                                    -1 === a.brand.indexOf("Brand") &&
                                    -1 === a.brand.indexOf("Chromium")
                            )[0];
                            return { name: a.brand, version: a.version };
                        }
                        let a = navigator.userAgent.match(
                            /(Firefox|Safari|Edge|Chrome)\/([\S]+)/i
                        );
                        if (navigator.brave && navigator.brave.isBrave())
                            var e = "Brave";
                        else e = a[0];
                        return { name: e, version: a[1].split(".")[0] };
                    }
                    async getOsAndTypeExp() {
                        if (void 0 === navigator.userAgentData) {
                            var a,
                                e = this.getOsAndType();
                            return [a, e];
                        }
                        ...
                        return (
                            await n.then((n) => {
                                "Windows" !== n.platform || n.mobile
                                    ? ((a = {
                                          name: n.platform,
                                          version: n.platformVersion,
                                      }),
                                      (e = n.mobile ? "mobile" : "desktop"))
                                    : ("10" === n.platformVersion.split(".")[0]
                                          ? (a = {
                                                name: "Windows",
                                                version: "10",
                                            })
                                          : "6" ===
                                            n.platformVersion.split(".")[0]
                                          ? (a = {
                                                name: "Windows",
                        ...
                        return (
                            (r =
                                r.indexOf("Win") > -1
                                    ...
                                    ? navigator.platform
                                    : r.indexOf("Android") > -1 ||
                                      r.indexOf("Linux armv7l") > -1
                                    ? "Android"
                                    : r.indexOf("Linux") > -1
                                    ? "Linux"
                                    : r.indexOf("Nintendo") > -1
                                    ? "Nintendo"
                                    : r.indexOf("PlayStation") > -1
                                    ? "PlayStation"
                                    : r.indexOf("BlackBerry") > -1 ||
                                      r.indexOf("BlackBerry") > -1
                                    ? "BlackBerry"
                                    : "unknown"),
                            a && "desktop" === e
                                ? a.indexOf("Windows") > -1
                                    ? (o =
                                          a.indexOf("NT 10.0") > -1
                                              ...
                                              : "8.1 or lower")
                                    : a.indexOf("Mac") &&
                                      (a.match("(OS X 10_10)|(OS X 10.10)")
                                          ? (o = "10.10")
                                          : a.match("(OS X 10_9)|(OS X 10.9)")
                                          ? (o = "10.9")
                                          : a.match("(OS X 10_8)|(OS X 10.8)")
                                          ? (o = "10.8")
                                          : a.match(
                                                "(OS X 10_7)|(OS X 10.7)"
                                            ) && (o = "10.7"))
                ...
                const c = class {
                    constructor(e) {
                        (this.api = new a(e)),
                            (this.locationInfo = new s()),
                            (this.deviceInfo = new m()),
                            (this.user = new o(this.api));
                    }
                    async initTracker() {
